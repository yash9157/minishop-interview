        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsRequestable = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetSystemId = table.Column<long>(type: "bigint", nullable: false),
                    RequestedRoleId = table.Column<Guid>(type: "char(36)", nullable: false),
                    BusinessJustification = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: false),
                    Status = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    SubmittedAtUtc = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    ProvisionedById = table.Column<Guid>(type: "char(36)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AccessRequests_AspNetUsers_RequesterId",
                        column: x => x.RequesterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AccessRequests_TargetSystems_TargetSystemId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DecisionAtUtc = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApprovalHistory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApprovalHistory_AccessRequests_AccessRequestId",
                        column: x => x.AccessRequestId,
                        principalTable: "AccessRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApprovalHistory_AspNetUsers_ApproverId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessRequests_RequesterId_CreatedAtUtc",
                table: "AccessRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessRequests_TargetSystemId",
                table: "AccessRequests",
                column: "TargetSystemId");

            migrationBuilder.CreateIndex(
                name: "IX_ApprovalHistory_AccessRequestId_Level",
                table: "ApprovalHistory",
                columns: new[] { "AccessRequestId", "Level" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ApprovalHistory_ApproverId_Decision",
                table: "ApprovalHistory",
